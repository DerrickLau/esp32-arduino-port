...
#include "C:\Derrick\esp-idf\components\arduino\tools\sdk\include\bt\esp_gap_bt_api.h"
...
static void esp_spp_cb(esp_spp_cb_event_t event, esp_spp_cb_param_t *param)
{
    ...
    case ESP_SPP_INIT_EVT:
        ...
        esp_bt_gap_set_scan_mode(esp_bt_scan_mode_t::ESP_BT_SCAN_MODE_CONNECTABLE_DISCOVERABLE);
        if (!_isMaster) {
