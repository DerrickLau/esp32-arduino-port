...
#define DPORT_SPI3_CLK_EN   (BIT(16)) /** Deprecated, please use DPORT_SPI3_CLK_EN **/
...
#define DPORT_SPI2_CLK_EN   (BIT(6)) /** Deprecated, please use DPORT_SPI2_CLK_EN **/
...
#define DPORT_SPI01_CLK_EN   (BIT(1)) /** Deprecated, please use DPORT_SPI01_CLK_EN **/
